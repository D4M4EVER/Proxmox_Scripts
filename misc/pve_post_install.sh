...
echo -e "\e[0;34m This script will Disable the Enterprise Repo, Add & Enable the No-Subscription Repo, 
...
echo -e "\e[0;34m No-Subscription Repo Updated....\e[0m"
apt update &>/dev/null
echo -e "\e[0;34m Updating Proxmox....Please wait....\e[0m"
apt -qqy upgrade &>/dev/null
echo -e "\e[0;34m Update Completed\e[0m"
